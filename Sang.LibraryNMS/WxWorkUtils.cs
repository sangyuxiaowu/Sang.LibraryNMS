...
namespace Sang.LibraryNMS
{
    ...
    public class WxWorkUtils
    {
        ...
        /// <returns></returns>
        public static string makeJsSignature(string ticket, long timestamp, string nonce, string url)
        {
            var str = $"jsapi_ticket={ticket}&noncestr={nonce}&timestamp={timestamp}&url={url}";
